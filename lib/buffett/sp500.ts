/**
 * S&P 500 constituent list — snapshot as of early 2025.
...
export const SP500_TICKERS: readonly string[] = [
  ...
  "EQT", "EFX", "EQIX", "EQR", "ESS", "EL", "ETSY", "EG", "EVRST", "ES",
  ...
  "GNRC", "GD", "GIS", "GM", "GPC", "GILD", "GPN", "GL", "GS", "HAL",
  ...
  "PAYX", "PAYC", "PYPL", "PNR", "PBCT", "PEP", "PFE", "PCG", "PM", "PSX",
  "PNW", "PXD", "PNC", "POOL", "PPG", "PPL", "PFG", "PG", "PGR", "PLD",
  "PRU", "PEG", "PTVE", "PSA", "PHM", "QRVO", "PWR", "QCOM", "DGX", "RL",
  ...
  "V", "VST", "VFC", "VICI", "VIEV", "VMC", "WRB", "GWW", "WAB", "WBA",
  "WMT", "DIS", "WBD", "WM", "WAT", "WEC", "WFC", "WELL", "WST", "WDC",
  "WY", "WHR", "WMB", "WTW", "WYNN", "XEL", "XYL", "YUM", "ZBRA", "ZBH",
  "ZTS",
] as const;
